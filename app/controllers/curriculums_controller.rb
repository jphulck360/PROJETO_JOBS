class CurriculumsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @curriculum.save
        format.html { redirect_to @curriculum, notice: 'Seu currículo foi craido!' }
  ...
  def update
    respond_to do |format|
      if @curriculum.update(curriculum_params)
        format.html { redirect_to @curriculum, notice: 'Curriculum atualizado!' }
  ...
  private
    ...
    def curriculum_params
      ...
      params.require(:curriculum).permit(
        ...
        :foto_curr,
        language_ids:[],
        experiences_attributes: [:id, :empresa, :data_inicial, :data_final, :career_id, :curriculum_id, :_destroy],
        curriculum_courses_attributes: [:id, :curriculum_id, :course_id, :instituicao, :data_inicial, :data_final, :_destroy],
        curriculum_languages_attributes: [:id, :nome, :_destroy]
      )
    end
end
